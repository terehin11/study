...
// DynamicWavePacket.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDynamicWavePacketApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CDynamicWavePacketApp

CDynamicWavePacketApp::CDynamicWavePacketApp()
{
...
// Единственный объект CDynamicWavePacketApp

CDynamicWavePacketApp theApp;


// инициализация CDynamicWavePacketApp

BOOL CDynamicWavePacketApp::InitInstance()
{
