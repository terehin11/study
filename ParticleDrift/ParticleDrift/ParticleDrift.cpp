...
// ParticleDrift.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CParticleDriftApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CParticleDriftApp

CParticleDriftApp::CParticleDriftApp()
{
...
// Единственный объект CParticleDriftApp

CParticleDriftApp theApp;


// Инициализация CParticleDriftApp

BOOL CParticleDriftApp::InitInstance()
{
