...
// MagneticRing.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMagneticRingApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMagneticRingApp

CMagneticRingApp::CMagneticRingApp()
{
...
// Единственный объект CMagneticRingApp

CMagneticRingApp theApp;


// Инициализация CMagneticRingApp

BOOL CMagneticRingApp::InitInstance()
{
